...
urlpatterns = [
    ...
    path('lesson/<int:id>/like', user_views.lesson_like, name='lesson_like'),
    path('lesson/<int:id>/completed', user_views.lesson_completed, name='lesson_completed'),
    path('course/<int:id>/like', user_views.course_like, name='course_like'),
    path('course/<int:id>/tag', user_views.course_tag, name='course_tag'),
    path('course/quote/<int:id>/like', user_views.quote_like, name='quote_like'),
    path('certificate/', user_views.mycertificateView, name='mycertificate'),
