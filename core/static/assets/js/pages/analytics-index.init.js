...
var options = {
        series: [
            { name: "بازدیدکنندگان جدید", data: [68, 44, 55, 57, 56, 61, 58, 63, 60, 66] },
        ...
        xaxis: { categories: ["فروردین", "اردیبهشت", "خرداد", "تیر", "مرداد", "شهریور", "مهر", "آبان", "آذر", "دی"], axisBorder: { show: !0, color: "#bec7e0" }, axisTicks: { show: !0, color: "#bec7e0" } },
        yaxis: { title: { text: "بازدید کنندگان", offsetX:-60 },
            offsetY: 200,},
        fill: { opacity: 1 },
    ...
    optionsCircle = {
        ...
        plotOptions: {
            radialBar: {
                inverseOrder: !0,
                hollow: { margin: 5, size: "55%", background: "transparent" },
