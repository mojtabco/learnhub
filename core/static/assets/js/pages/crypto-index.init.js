var options = {
    ...
    chart: {type: "candlestick", height: 370},
    plotOptions: {candlestick: {colors: {upward: "#22b783", downward: "#ef4d56"}, wick: {useFillColor: !0}}},
    xaxis: {type: "datetime", tickPlacement: "between"},
    yaxis: {tooltip: {enabled: !0} , labels:{ offsetX: -30 }}
}, chart = new ApexCharts(document.querySelector("#crypto_dash_main"), options);
chart.render();