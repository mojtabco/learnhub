document.addEventListener("DOMContentLoaded", function (e) {
    ...
    new JustGage({id: "gg1", value: 125, title: "javascript call", defaults: n}), new JustGage({
        id: "gg2",
    ...
    var a = new JustGage({
        ...
        onAnimationEnd: function () {
            ...
            e.innerHTML = e.innerHTML + "انیمیشن به تازگی به پایان رسیده است.<br/>"
        }
        ...
        gaugeColor: ["rgba(42, 118, 244, .1)"],
        levelColors: ["#4c7cf5"],
        pointerOptions: {toplength: 5, bottomlength: 15, bottomwidth: 2},
        counter: !0,
        donut: !0
    };
    new JustGage({id: "jg1", defaults: n}), new JustGage({id: "jg2", defaults: n}), new JustGage({
        id: "jg3",
        defaults: n
    }), new JustGage({id: "jg4", defaults: r}), new JustGage({id: "jg5", defaults: r}), new JustGage({
        id: "jg6",
        defaults: r
    })
});