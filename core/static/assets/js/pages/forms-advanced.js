new Selectr("#default"), new Selectr("#multiSelect", {multiple: !0}), new Selectr("#taggableSelect", {
    taggable: !0,
    tagSeperators: [",", "|"]
});
var hueb = new Huebee(".color-input", {setBGColor: !0, saturations: 3}),
    elem = document.querySelector('input[name="foo"]'),
    regExpMask = (new Datepicker(elem, {}), elem = document.getElementById("inline_calendar"), new Datepicker(elem, {}), elem = document.getElementById("DateRange"), new DateRangePicker(elem, {}), IMask(document.getElementById("regexp-mask"), {mask: /^[1-6]\d{0,5}$/})),
    startPhoneMask = IMask(document.getElementById("start-phone-mask"), {mask: "+{7}(000)000-00-00"}).on("accept", function () {
        ...
        mask: /^\w+$/, prepare: function (e) {
            return e.toUpperCase()
        }, commit: function (e, t) {
            t._value = e.toLowerCase()
        }
    }), "YYYY/MM/DD HH:mm"), momentMask = IMask(document.getElementById("moment-mask"), {
        mask: Date,
