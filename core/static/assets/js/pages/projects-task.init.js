var options = {
    ...
    plotOptions: {
        radialBar: {
            hollow: {margin: 10, size: "55%", background: "transparent"},
            dataLabels: {name: {fontSize: "18px"}, value: {fontSize: "16px", color: "#50649c"}, total: {show: !0}},
            track: {show: !0}
        }
    },
    colors: ["#7680ff", "#80e6e6", "#7ebcff"],
    stroke: {lineCap: "round"},
    labels: ["تکمیل شده", "فعال", "اختصاص یافته"],
