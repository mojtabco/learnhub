...
var options = {
    series: [{ name: "رایانه", data: [10, 41, 35, 51, 49, 62, 69, 91, 148] }],
    chart: { height: 350, type: "line", zoom: { enabled: !1 } },
    colors: ["#008ffb"],
    dataLabels: { enabled: !1 },
    stroke: { curve: "straight", width: [3] },
    title: { text: "روند محصول بر اساس ماه", align: "center" },
    grid: { row: { colors: ["#f3f3f3", "transparent"], opacity: .5 } },
    xaxis: { categories: ["فروردین", "اردیبهشت", "خرداد", "تیر", "مرداد", "شهریور", "مهر", "آبان", "آذر"] }
}, chart = new ApexCharts(document.querySelector("#apex_line1"), options), options = (chart.render(), {
    series: [{ name: "بالا - 1390", data: [28, 29, 33, 36, 32, 32, 33] }, {
        name: "پایین - 1390",
    ...
    chart: {
        height: 350,
        type: "line",
        dropShadow: { enabled: !0, color: "#45404a2e", top: 18, left: 7, blur: 10, opacity: .2 },
        toolbar: { show: !1 }
    },
    ...
    grid: { borderColor: "#45404a2e", row: { colors: ["#f3f3f3", "transparent"], opacity: .5 }, strokeDashArray: 4 },
    markers: { size: 2 },
    xaxis: { categories: ["فروردین", "اردیبهشت", "خرداد", "تیر", "مرداد", "شهریور", "مهر"], title: { text: "ماه" } },
    ...
    colors: ["#2a77f4", "#a5c2f1"],
    dataLabels: { enabled: !1 },
    stroke: { curve: "smooth", width: [3, 3], dashArray: [0, 4], lineCap: "round" },
    grid: { borderColor: "#45404a2e", padding: { left: 0, right: 0 }, strokeDashArray: 4 },
    markers: { size: 0, hover: { size: 0 } },
    series: [{ name: "بازدیدهای جدید", data: [0, 60, 20, 90, 45, 110, 55, 130, 44, 110, 75, 120] }, {
        name: "بازدیدهای یکتا",
    ...
    options = ((chart = new ApexCharts(document.querySelector("#apex_area1"), options)).render(), document.addEventListener("DOMContentLoaded", function () {
        ...
        var e = {
            annotations: {
                yaxis: [{
                    y: 30,
                    borderColor: "#999",
                    label: { show: !0, text: "Support", style: { color: "#fff", background: "#03d87f" } }
                }],
                xaxis: [{
                    x: new Date("14 بهمن 1390").getTime(),
                    borderColor: "#999",
                    yAxisIndex: 0,
                    label: { show: !0, text: "Rally", style: { color: "#fff", background: "#ffb822" } }
                }]
            },
            ...
            tooltip: {
                ...
                tooltip: {
                    formatter: function (val) {
                        return val.y + " - " + val.series.name;
                    },
                    custom: function (options) {
                        options.title = options.title.replace(/([a-zA-Z]+)/g, function (match) {
                            return translations[match];
                        });
                        options.body.forEach(function (item) {
                            item.text = item.text.replace(/([a-zA-Z]+)/g, function (match) {
                                return translations[match];
                            });
                        });
                        return options;
            ...
            fill: { type: "gradient", gradient: { shadeIntensity: 1, opacityFrom: .7, opacityTo: .4, stops: [0, 100] } }
        ...
        document.querySelector("#one_month").addEventListener("click", function (e) {
            ...
            t(e), a.updateOptions({ xaxis: { min: void 0, max: void 0 } })
...

    {
        ...
        series: [{ name: "سود خالص", data: [44, 55, 57, 56, 61, 58, 63, 60, 66] }, {
            name: "درآمد",
            data: [76, 85, 101, 98, 87, 105, 91, 114, 94]
        }, { name: "جریان ازاد نقدینگی", data: [35, 41, 36, 26, 45, 48, 52, 53, 41] }],
        xaxis: {
            categories: ["اردیبهشت", "خرداد", "تیر", "مرداد", "شهریور", "مهر", "آبان", "آذر", "دی"],
            axisBorder: { show: !0, color: "#bec7e0" },
            axisTicks: { show: !0, color: "#bec7e0" }
        },
        legend: { offsetY: 6 },
        ...
        colors: ["#2a76f4"],
        series: [{ name: "تورم", data: [2.3, 3.1, 4, 10.1, 4, 3.6, 3.2, 2.3, 1.4, .8, .5, .2] }],
        xaxis: {
            categories: ["فروردین", "اردیبهشت", "خرداد", "تیر", "مرداد", "شهریور", "مهر", "آبان", "آذر", "دی", "بهمن", "اسفند"],
            position: "top",
            labels: { offsetY: -18 },
        ...
        title: {
            text: "تورم ماهانه در آرژانتین، 1380",
            floating: !0,
            offsetY: 360,
            align: "center",
            style: { color: "#8997bd" }
        },
        grid: { row: { colors: ["#afb7d21a", "transparent"], opacity: .2 }, borderColor: "#f1f3fa" }
        ...
        dataLabels: { enabled: !1 },
        series: [{ data: [400, 430, 448, 470, 540, 580, 690, 1100, 1200, 1380], name: "سری ۱" }],
        colors: ["#2a76f4"],
        yaxis: {
        ...
        xaxis: { categories: ["کره جنوبی", "کانادا", "انگلستان", "هلند", "ایتالیا", "فرانسه", "ژاپن", "ایالات متحده", "چین", "آلمان"] },
    ...
    options = ((chart = new ApexCharts(document.querySelector("#apex_bar"), options)).render(), {
        ...
        dataLabels: { enabled: !1 },
        stroke: { width: [0, 0, 3] },
        series: [{ name: "درآمد", type: "column", data: [1.4, 2, 2.5, 1.5, 2.5, 2.8, 3.8, 4.6] }, {
            name: "جریان نقدی",
            type: "column",
        ...
        yaxis: [{
            axisTicks: { show: !0, },
            axisBorder: { show: !0, color: "#20016c", labels: { offsetX: 10 } },
            ...
            labels: { style: { color: "#77d0ba" }, },
            title: {
                text: "جریان نقدی عملیاتی (هزار تومان)",
                offsetX: -160
            }
        }, {
            opposite: !0,
        ...
        tooltip: {
            followCursor: !0, y: {
                formatter: function (e) {
                    return void 0 !== e ? e + "هزار تومان" : e
                }
            }
        },
        grid: { borderColor: "#f1f3fa" },
...
function generateData1(e, t, a) {
    for (var o = 0, r = []; o < t;) {
        var n = Math.floor(Math.random() * (a.max - a.min + 1)) + a.min, s = Math.floor(61 * Math.random()) + 15;
...
var options2 = {
        ...
        series: [{
            ...
            name: "محصول 3",
            data: generateData1(new Date("11 Feb 2017 GMT").getTime(), 20, {min: 10, max: 60})
        }, {name: "محصول 4", data: generateData1(new Date("11 Feb 2017 GMT").getTime(), 20, {min: 10, max: 60})}],
        fill: {type: "gradient"},
    ...
    xaxis: {
         type: "datetime", axisBorder: { show: !0, color: "#bec7e0" }, axisTicks: { show: !0, color: "#bec7e0" }
    },
    yaxis: {
        labels: {
            offsetX: -43,
    ...
    series: [{
        data: [{
            x: "دهلی نو",
            y: 218
        }, { x: "کلکته", y: 149 }, { x: "بمبئی", y: 184 }, { x: "احمدآباد", y: 55 }, { x: "بنگلور", y: 84 }, {
            x: "پونه",
            y: 31
        }, { x: "چنای", y: 70 }, { x: "جیپور", y: 30 }, { x: "سورات", y: 44 }, { x: "حیدرآباد", y: 68 }, {
            x: "لاکناو",
            y: 28
        }, { x: "ایندور", y: 19 }, { x: "کانپور", y: 29 }]
    }], legend: { show: !1 }, chart: { height: 350, type: "treemap", toolbar: { show: !1 } }
    ...
    chart: { type: "polarArea", width: 380 },
    labels: ["سری 1", "سری 2", "سری 3", "سری 4", "سری 5", "سری 2", "سری 3", "سری 4", "سری 5"],
    stroke: { colors: ["#fff"] },
    fill: { opacity: .8 },
    ...
    labels: ["رز 1", "رز 2", "رز 3", "رز 4", "رز 5"],
    fill: { opacity: 1 },
    stroke: { width: 1, colors: void 0 },
    yaxis: { show: !1 },
    legend: { position: "bottom" },
    plotOptions: { polarArea: { rings: { strokeWidth: 0 } } },
    theme: { monochrome: { enabled: !0, shadeTo: "light", shadeIntensity: .6 } }
    ...
    plotOptions: {
        radialBar: {
            hollow: { size: "70%" },
            track: { background: "#b9c1d4", opacity: .5 },
            dataLabels: { name: { fontSize: "18px" }, value: { fontSize: "16px", color: "#8997bd" } }
        }
    },
    colors: ["#4a8af6"],
    series: [70],
    ...
    plotOptions: {
        radialBar: {
            ...
            dataLabels: {
                ...
                total: {
                    show: !0, label: "مجموع", color: "#8997bd", formatter: function (e) {
                        return 249
                    }
                }
            }
    ...
    plotOptions: {
        radialBar: {
            startAngle: -135,
            endAngle: 135,
            track: { background: "#b9c1d4", opacity: .3 },
            dataLabels: {
                name: { fontSize: "16px", color: "#8997bd", offsetY: 120 },
                value: {
                    offsetY: 76, fontSize: "22px", color: "#8997bd", formatter: function (e) {
                        return e + "%"
                    }
                }
            }
    ...
    }, Apex.dataLabels = { enabled: !1 }, function (e) {
    ...
    colorPalette = ["#00D8B6", "#008FFB", "#اردیبهشت019", "#FF4560", "#775DD0"], spark1 = {
        chart: { type: "area", height: 160, sparkline: { enabled: !0 } },
        stroke: { width: 2, curve: "straight" },
        fill: { opacity: .2 },
        series: [{ name: "متریکا فروش ", data: randomizeArray(sparklineData) }],
        yaxis: { min: 0 },
        colors: ["#f93b7a"],
        title: { text: "424,652 تومان", offsetX: 120, style: { fontSize: "16px", color: "#8997bd", fontWeight: "500" } },
        subtitle: { text: "فروش", offsetX: 100, style: { fontSize: "18px", color: "#8997bd" } }
        ...
        fill: { opacity: .2 },
        series: [{ name: "هزینه‌های متریکا ", data: randomizeArray(sparklineData) }],
        yaxis: { min: 0 },
        colors: ["#fbb624"],
        title: { text: "235,312 تومان", offsetX: 120, style: { fontSize: "16px", color: "#8997bd", fontWeight: "500" } },
        subtitle: { text: "هزینه", offsetX: 100, style: { fontSize: "18px", color: "#8997bd" } }
        ...
        yaxis: { min: 0 },
        colors: ["#0acf97"],
        title: { text: "135,965 تومان", offsetX: 120, style: { fontSize: "16px", color: "#8997bd", fontWeight: "500" } },
        subtitle: { text: "سود", offsetX: 100, style: { fontSize: "18px", color: "#8997bd" } }
    });
var translations = {
    y: "مقدار",
    series: "سری",
