...
collapses.forEach(t => {
    ...
    t.addEventListener("show.bs.collapse", e => {
        ...
        null != e && e.querySelectorAll(".collapse").forEach(e => {
            e = bootstrap.Collapse.getInstance(e);
            e !== a && e.hide()
        })
    }), t.addEventListener("hide.bs.collapse", e => {
        e.stopPropagation(), t.querySelectorAll(".collapse").forEach(e => {
...
var tooltipTriggerList = [].slice.call(document.querySelectorAll('[data-bs-toggle="tooltip"]')),
    ...
    }), dropdowns = document.querySelectorAll(".dropup, .dropend, .dropdown, .dropstart"), events = ["click"];
...
[].forEach.call(dropdowns, function (t) {
    ...
    e ? e.addEventListener(events[0], function (e) {
        toggleDropdown(e, t)
    }) : hideDropdowns(t)
}), document.querySelectorAll(".menu-body a").forEach(function (e, t) {
    var a = window.location.href.split(/[?#]/)[0], n = e;
    ...
    if (e.href == a) {
        for (var a = e, n = (a.classList.add("active"), a.getAttribute("aria-labelledby")); ;) {
            var o = document.querySelector("#" + n);
            if (o?.classList.add("active"), n = o?.getAttribute("aria-labelledby"), o?.setAttribute("aria-expanded", "true"), !n) break
        }
        a.parentNode.parentNode.classList.add("active"), a.parentNode.parentNode.parentElement.querySelector(".nav-link")?.classList.add("active"), a.parentNode.parentNode.parentNode.parentNode.classList.add("active"), a.parentNode.parentNode.parentNode.parentNode.parentNode.parentNode.classList.add("active")
    }
