...
!function (e, t) {
    ...
    class d extends l {
        ...
        rerenderColumns(e, t) {
            var i = {cols: this.columns, leftCol: this.leftCol, rightCol: this.rightCol}, s = 0;
        ...
        addColLeft() {
            for (var e = !1, t = !0; t;) {
                ...
                if (i) if (i.modules.vdomHoz.rightPos >= this.vDomScrollPosLeft) {
    ...
    class c extends e {
        ...
        scrollToColumn(e, t, i) {
            var s = 0, o = e.getLeftOffset(), n = 0, r = e.getElement();
            return new Promise(((a, l) => {
    ...
    class g extends l {
        ...
        scrollRows(e, t) {
            var i = e - this.vDomScrollPosTop, s = e - this.vDomScrollPosBottom, o = 2 * this.vDomWindowBuffer,
                n = this.rows();
        ...
        visibleRows(e) {
            var t = this.elementVertical.scrollTop, i = this.elementVertical.clientHeight + t, s = !1, o = 0, n = 0,
                r = this.rows();
        ...
        _virtualRenderFill(e, t, i) {
            var s, o, n = this.tableElement, a = this.elementVertical, l = 0, h = 0, d = 0, c = 0, u = 0, p = 0,
                m = this.rows(), g = m.length, b = 0, f = [], v = 0, w = 0, C = this.table.rowManager.fixedHeight,
                E = this.elementVertical.clientHeight, y = this.table.options.rowHeight, R = !0;
            if (i = i || 0, e = e || 0) {
    ...
    class b extends e {
        ...
        initialize() {
            this.initializePlaceholder(), this.initializeRenderer(), this.element.appendChild(this.tableElement), this.firstRender = !0, this.element.addEventListener("scroll", (() => {
                var e = this.element.scrollLeft, t = this.scrollLeft > e, i = this.element.scrollTop,
                    s = this.scrollTop > i;
        ...
        refreshActiveData(e, t, i) {
            ...
            if (!this.table.destroyed) {
                if ("function" == typeof e) if ((n = this.dataPipeline.findIndex((t => t.handler === e))) > -1) o = "dataPipeline", t && (n == this.dataPipeline.length - 1 ? o = "display" : n++); else {
    ...
    class v extends e {
        ...
        pseudoMouseLeave(e, t) {
            var i = Object.keys(this.pseudoTrackers), s = {row: ["cell"], cell: ["row"]};
            (i = i.filter((t => {
                var i = s[e];
    ...
    var L = {
        fitData: function (e, t) {
        ...
        }, fitDataFill: M, fitDataTable: M, fitDataStretch: function (e, t) {
            ...
            var i, s, o = this.table.rowManager.element.getBoundingClientRect().width, n = 0, r = 0, a = 0, l = [],
                h = [], d = 0, c = 0;
            ...
            this.table.options.responsiveLayout && this.table.modExists("responsiveLayout", !0) && this.table.modules.responsiveLayout.update(), this.table.rowManager.element.scrollHeight > this.table.rowManager.element.clientHeight && (o -= this.table.rowManager.element.offsetWidth - this.table.rowManager.element.clientWidth), e.forEach((function (e) {
                ...
                e.visible && (t = e.definition.width, i = parseInt(e.minWidth), t ? (s = u(t), n += s > i ? s : i, e.definition.widthShrink && (h.push({
                    column: e,
                    width: s > i ? s : i
                }), d += e.definition.widthShrink)) : (l.push({column: e, width: 0}), a += e.definition.widthGrow || 1))
    ...
    P.moduleName = "comms";
    var z = Object.freeze({__proto__: null, LayoutModule: S, LocalizeModule: D, CommsModule: P});
        ...
        bindStaticFunctionality(e) {
            e.moduleBindings = {}, e.extendModule = function (t, i, s) {
                if (e.moduleBindings[t]) {
                    ...
                    if (o) if ("object" == typeof s) for (let e in s) o[e] = s[e]; else console.warn("Module Error - Invalid value type, it must be an object"); else console.warn("Module Error - property does not exist:", i)
    ...
    class A extends k {
        ...
        transformRow(e, t) {
            var i = "accessor" + (t.charAt(0).toUpperCase() + t.slice(1)), s = e.getComponent(),
    ...
    class W extends k {
        constructor(e) {
            ...
            })), this.registerTableOption("ajaxResponse", !1), this.contentTypeFormatters = W.contentTypeFormatters
        }
    ...
    W.moduleName = "ajax", W.defaultConfig = {method: "GET"}, W.defaultURLGenerator = I, W.defaultLoaderPromise = function (e, t, i) {
        var s;
        return new Promise(((o, n) => {
    ...
    class X extends k {
        ...
        initializeColumn(e) {
            var t = e.definition, i = {topCalcParams: t.topCalcParams || {}, botCalcParams: t.bottomCalcParams || {}};
            if (t.topCalc) {
    ...
    var K = {
        csv: function (e, t = {}, i) {
            ...
            var o = i.sheetName || "Sheet1", n = XLSX.utils.book_new(), r = new e(this),
            ...
            function h() {
                var e = [], i = [], s = {}, o = {
                    s: {c: 0, r: 0},
                    e: {c: t[0] ? t[0].columns.reduce(((e, t) => e + (t && t.width ? t.width : 1)), 0) : 0, r: t.length}
                };
    ...
    function Y(e, t) {
        var i = t.mask, s = void 0 !== t.maskLetterChar ? t.maskLetterChar : "A",
...
_ajaxRequest(e, t)
{
    return e = I(e, {}, this.params.filterRemote ? {term: t} : {}), fetch(e).then((e => e.ok ? e.json().catch((e => (console.warn("List Ajax Load Error - Invalid JSON returned", e), Promise.reject(e)))) : (console.error("List Ajax Load Error - Connection Error: " + e.status, e.statusText), Promise.reject(e)))).catch((e => (console.error("List Ajax Load Error - Connection Error: ", e), Promise.reject(e))))
}
...
{
    var t = [];
    return Array.isArray(e) || (e = Object.entries(e).map((([e, t]) => ({label: t, value: e})))), e.forEach((e => {
...
var Z = {
    input: function (e, t, i, s, o) {
        ...
        var n = e.getValue(), r = o.verticalNavigation || "hybrid", a = String(null != n ? n : ""),
            l = document.createElement("textarea"), h = 0;
        ...
        var n = o.format, r = o.verticalNavigation || "editor", a = n ? window.DateTime || luxon.DateTime : null,
            l = e.getValue(), h = document.createElement("input");
        ...
        var n, r = o.format, a = o.verticalNavigation || "editor", l = r ? window.DateTime || luxon.DateTime : null,
            h = e.getValue(), d = document.createElement("input");
        ...
        var n = this, r = e.getElement(), a = e.getValue(), l = r.getElementsByTagName("svg").length || 5,
            h = r.getElementsByTagName("svg")[0] ? r.getElementsByTagName("svg")[0].getAttribute("width") : 14, d = [],
            c = document.createElement("div"), u = document.createElementNS("http://www.w3.org/2000/svg", "svg");
        ...
        var n, r, a = e.getElement(),
            ...
            d = (l - h) / 100, c = e.getValue() || 0, u = document.createElement("div"),
        ...
        var n = e.getValue(), r = document.createElement("input"), a = o.tristate,
            l = void 0 === o.indeterminateValue ? null : o.indeterminateValue, h = !1,
            d = Object.keys(o).includes("trueValue"), c = Object.keys(o).includes("falseValue");
...
class ie extends k {
    ...
    generateTableElement(e) {
        var t = document.createElement("table"), i = document.createElement("thead"),
            s = document.createElement("tbody"), o = this.lookupTableStyles(),
    ...
    generateRowElement(e, t, i) {
        ...
        if (s.classList.add("tabulator-print-table-row"), e.columns.forEach(((o, n) => {
            if (o) {
                var r, a = document.createElement("td"), l = o.component._column,
                    h = this.table.columnManager.findColumnIndex(l), d = o.value, c = {
...
var se = {
    "=": function (e, t, i, s) {
        ...
        var o = e.toLowerCase().split(void 0 === s.separator ? " " : s.separator),
            n = String(null == t ? "" : t).toLowerCase(), r = [];
        return o.forEach((e => {
...
class oe extends k {
    ...
    generateHeaderFilterElement(e, t, i) {
        var s, o, n, r, a, l, h, d, c = this, u = e.modules.filter.success, p = e.getField();
        if (e.modules.filter.value = t, e.modules.filter.headerElement && e.modules.filter.headerElement.parentNode && e.contentElement.removeChild(e.modules.filter.headerElement.parentNode), p) {
            ...
            if (o) {
                ...
                }), h))) return void console.warn("Filter Error - Cannot add filter to " + p + " column, editor returned a value of false");
    ...
    addFilter(e, t, i, s) {
        var o = !1;
        Array.isArray(e) || (e = [{field: e, type: t, value: i, params: s}]), e.forEach((e => {
    ...
    removeFilter(e, t, i) {
        Array.isArray(e) || (e = [{field: e, type: t, value: i}]), e.forEach((e => {
            var t = -1;
    ...
    search(e, t, i, s) {
        var o = [], n = [];
        return Array.isArray(t) || (t = [{field: t, type: i, value: s}]), t.forEach((e => {
...
var ne = {
    plaintext: function (e, t, i) {
        ...
        var s, o, n, r, a, l = parseFloat(e.getValue()), h = "", d = t.decimal || ".", c = t.thousand || ",",
            u = t.negativeSign || "-", p = t.symbol || "", m = !!t.symbolAfter,
        ...
        var s, o = e.getValue(), n = t.urlPrefix || "", a = t.download, l = o, h = document.createElement("a");
        ...
        if (l) {
            if (t.urlField && (s = e.getData(), o = r.retrieveNestedData(this.table.options.nestedFieldSeparator, t.urlField, s)), t.url) switch (typeof t.url) {
                case"string":
                    o = t.url;
                    break;
                case"function":
            ...
            return h.setAttribute("href", n + o), t.target && h.setAttribute("target", t.target), t.download && (a = "function" == typeof a ? a(e) : !0 === a ? "" : a, h.setAttribute("download", a)), h.innerHTML = this.emptyToSpace(this.sanitizeHTML(l)), h
        }
        return "&nbsp;"
        ...
        var s = e.getValue(), o = e.getElement(), n = t.allowEmpty, r = t.allowTruthy,
        ...
        var s, o = window.DateTime || luxon.DateTime, n = t.inputFormat || "yyyy-MM-dd HH:mm:ss",
            r = t.outputFormat || "dd/MM/yyyy HH:mm:ss",
            a = void 0 !== t.invalidPlaceholder ? t.invalidPlaceholder : "", l = e.getValue();
        ...
        var s, o = window.DateTime || luxon.DateTime, n = t.inputFormat || "yyyy-MM-dd HH:mm:ss",
            r = void 0 !== t.invalidPlaceholder ? t.invalidPlaceholder : "", a = void 0 !== t.suffix && t.suffix,
            l = void 0 !== t.unit ? t.unit : "days", h = void 0 !== t.humanize && t.humanize,
            d = void 0 !== t.date ? t.date : o.now(), c = e.getValue();
        ...
        var s = e.getValue(), o = e.getElement(), n = t && t.stars ? t.stars : 5, r = document.createElement("span"),
        ...
        var s, o, n = this.sanitizeHTML(e.getValue()) || 0, r = document.createElement("span"),
            a = t && t.max ? t.max : 100, l = t && t.min ? t.min : 0,
            h = t && void 0 !== t.color ? t.color : ["red", "orange", "green"], d = "#666666";
        ...
        var o, n, r, a, l, h = this.sanitizeHTML(e.getValue()) || 0, d = e.getElement(), c = t.max ? t.max : 100,
            u = t.min ? t.min : 0, p = t.legendAlign ? t.legendAlign : "center";
        switch (n = parseFloat(h) <= c ? parseFloat(h) : c, n = parseFloat(n) >= u ? parseFloat(n) : u, o = (c - u) / 100, n = Math.round((n - u) / o), typeof t.color) {
            ...
            case"object":
                if (Array.isArray(t.color)) {
                    let e = 100 / t.color.length, i = Math.floor(n / e);
        ...
        switch (typeof t.legendColor) {
            ...
            case"object":
                if (Array.isArray(t.legendColor)) {
                    let e = 100 / t.legendColor.length, i = Math.floor(n / e);
...
class ce extends k {
    ...
    configureGroupSetup() {
        if (this.table.options.groupBy) {
            var e = this.table.options.groupBy, t = this.table.options.groupStartOpen,
            ...
            })), t && (Array.isArray(t) || (t = [t]), t.forEach((e => {
    ...
    pullGroupListData(e) {
        var t = [];
        return e.forEach((e => {
            var i = {level: 0, rowCount: 0, headerContent: ""}, s = [];
...
class pe extends k {
    ...
    parseTable() {
        var e = this.table.originalElement, t = this.table.options, i = e.getElementsByTagName("th"),
            s = e.getElementsByTagName("tbody")[0], o = [];
...
class we extends k {
    ...
    bindTouchEvents(e) {
        ...
        }), {passive: !0}), a.addEventListener("touchmove", (a => {
            var h, d;
        ...
        }), {passive: !0}), a.addEventListener("touchend", (e => {
            this.checkTimeout && clearTimeout(this.checkTimeout), this.moving && this.endMove(e)
        }))
    }

    startMove(e, t) {
        var i = t.getElement(), s = this.table.columnManager.getContentsElement(),
    ...
    moveHover(e) {
        var t, i = this.table.columnManager.getContentsElement(), s = i.scrollLeft,
...
class Ce extends k {
    ...
    bindTouchEvents(e, t) {
        ...
        }), {passive: !0}), this.moving, this.toRow, this.toRowAfter, t.addEventListener("touchmove", (t => {
            var h, d;
    ...
    connectToTables(e) {
        var t;
        this.connectionSelectorsTables && (t = this.commsConnections(this.connectionSelectorsTables), this.dispatchExternal("movableRowsSendingStart", t), this.commsSend(this.connectionSelectorsTables, "moveRow", "connect", {row: e})), this.connectionSelectorsElements && (this.connectionElements = [], Array.isArray(this.connectionSelectorsElements) || (this.connectionSelectorsElements = [this.connectionSelectorsElements]), this.connectionSelectorsElements.forEach((e => {
...
var ye = {
    rows: function (e, t, i, s, o) {
        var n = document.createElement("span"), r = document.createElement("span"), a = document.createElement("span"),
            l = document.createElement("span"), h = document.createElement("span"), d = document.createElement("span");
...
class Re extends k {
    ...
    _setPageButtons() {
        let e = Math.floor((this.count - 1) / 2), t = Math.ceil((this.count - 1) / 2),
...
class Le extends k {
    ...
    printFullscreen(e, t, i) {
        var s, o, n = window.scrollX, r = window.scrollY, a = document.createElement("div"),
...
class Se extends k {
    ...
    watchData(e) {
        ...
        this.currentVersion++, t = this.currentVersion, this.unwatchData(), this.data = e, this.origFuncs.push = e.push, Object.defineProperty(this.data, "push", {
            ...
            configurable: !0,
            value: function () {
                var s, o, n = Array.from(arguments), r = n[0] < 0 ? e.length + n[0] : n[0], a = n[1],
                    l = !!n[2] && n.slice(2);
    ...
    watchTreeChildren(e) {
        ...
        i && (s.push = i.push, Object.defineProperty(i, "push", {
            enumerable: !1, configurable: !0, value: () => {
                if (!t.blocked) {
                    t.block("tree-push");
...
class De extends k {
    ...
    initializeColumn(e, t, i, s) {
        ...
        if ("header" === e && (r = {variableHeight: "textarea" == i.definition.formatter || i.definition.variableHeight}), (!0 === n || n == e) && this._checkResizability(a)) {
            ...
            l.addEventListener("mousedown", h), l.addEventListener("touchstart", h, {passive: !0}), l.addEventListener("dblclick", (e => {
                var t = a.getWidth();
...
class Pe extends k {
    ...
    initializeRow(e) {
        ...
        s.addEventListener("mousedown", n), s.addEventListener("touchstart", n, {passive: !0}), o.addEventListener("click", (function (e) {
            e.stopPropagation()
        }));
        var r = function (i) {
    ...
    _mouseDown(e, t, i) {
        ...
        s.table.element.classList.add("tabulator-block-select"), e.stopPropagation(), s.startY = void 0 === e.screenY ? e.touches[0].screenY : e.screenY, s.startHeight = t.getHeight(), document.body.addEventListener("mousemove", o), document.body.addEventListener("mouseup", n), i.addEventListener("touchmove", o, {passive: !0}), i.addEventListener("touchend", n)
    }
}
...
class Fe extends k {
    ...
    formatCollapsedData(e) {
        ...
        return e.forEach((function (e) {
            var i, s = document.createElement("tr"), o = document.createElement("td"), n = document.createElement("td"),
    ...
    handleComplexRowClick(e, t) {
        if (t.shiftKey) {
            ...
            var i = this.table.rowManager.getDisplayRowIndex(this.lastClickedRow),
                s = this.table.rowManager.getDisplayRowIndex(e), o = i <= s ? i : s, n = i >= s ? i : s,
...
var Ae = {
    ...
    }, datetime: Oe, boolean: function (e, t, i, s, o, n, r) {
...
class _e extends k {
    ...
    sort(e) {
        var t = this, i = this.table.options.sortOrderReverse ? t.sortList.slice().reverse() : t.sortList, s = [],
            o = [];
