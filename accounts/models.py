...
class ProfileUser(models.Model):
    ...
    access_groups = models.ManyToManyField(SiteAccessGroup, related_name='members', blank=True)
    access_users = models.ManyToManyField(SiteAccessUser, related_name='profile_access', blank=True)
